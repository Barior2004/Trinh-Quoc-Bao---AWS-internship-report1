...
!(function () {
  ...
  ((z.version = "2.3.5"),
    ...
    (z.Token.prototype.up.Date = function (e) {
    ...
    (z.tokenizer = function (e, t) {
      ...
      for (
        var r = e.toString().trim().toLowerCase(),
          i = r.length,
          n = [],
          s = 0,
          o = 0;
    ...
    (z.Index.prototype.query = function (e) {
      ...
      for (a = 0; a < F.length; a++) {
        ...
        if (O.contains(_) && !I.contains(_)) {
          var D,
            A = this.fieldVectors[j],
            B = i[j.fieldName].similarity(A);
          if (void 0 !== (D = N[_]))
            ((D.score += B), D.matchData.combine(r[j]));
          else {
            var V = { ref: _, score: B, matchData: r[j] };
            ((N[_] = V), C.push(V));
          }
        }
      }
      ...
      if (null != t)
        switch (t.type) {
          ...
          default:
            ...
            throw (
              1 <= t.str.length && (r += " with value '" + t.str + "'"),
